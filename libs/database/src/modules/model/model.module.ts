...
import { Video, VideoSchema, VideoDocName, User, UserSchema, UserDocName, Type, TypeSchema, TypeDocName, Topic, TopicSchema, TopicDocName, Gbook, GbookSchema, GbookDocName, Article, ArticleSchema, ArticleDocName, Admin, AdminSchema, AdminDocName, Comment, CommentSchema, CommentDocName, Uact, UactSchema, UactDocName } from "../../schemas";
